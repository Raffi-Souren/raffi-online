...
export default function DesktopIcon({ icon, label, onClick }: DesktopIconProps) {
  console.log("[v0] DesktopIcon rendering:", label)
  
  return (
    <div
      onClick={onClick}
      className="flex flex-col items-center cursor-pointer group p-2 rounded hover:bg-white hover:bg-opacity-20 transition-all duration-200"
    >
