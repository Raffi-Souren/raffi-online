    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-900 p-4">
      ...
      <div className="mt-4 text-center">
        <p className="text-gray-400 text-sm font-mono mb-2">
          Prove you are human by slaying demons.
        </p>
        <div className="text-xs text-gray-500">
          Credit: <a href="https://x.com/rauchg/status/1874130110120706556" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Guillermo Rauch</a>
        </div>
      </div>
    </div>
  )
