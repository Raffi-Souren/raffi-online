        ...
        <div className="w-full h-full bg-white flex items-center justify-center">
          <div className="w-full max-w-md mx-auto">
            <blockquote
              ...
              data-instgrm-permalink="https://www.instagram.com/boweryshowroom/"
            ...
            >
              ...
              >
                <a
                  href="https://www.instagram.com/boweryshowroom/"
                  style={{
                    color: "#c9c8cd",
                    fontFamily: "Arial,sans-serif",
                    fontSize: "14px",
                ...
                >
                  A post shared by Bowery Showroom (@boweryshowroom)
                </a>
              </p>
            </blockquote>
    ...
    return (
      <div className="window fixed inset-0 md:inset-auto md:top-20 md:left-1/2 md:-translate-x-1/2 w-full md:w-[900px] h-[90vh] md:h-[700px] overflow-hidden z-50">
        <div className="window-title sticky top-0 z-10">
          ...
          <button className="ml-auto" onClick={() => setActiveEmbed(null)}>
