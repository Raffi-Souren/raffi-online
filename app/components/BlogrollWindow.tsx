  ...
  if (activeEmbed) {
    ...
    return (
      <div className="fixed inset-0 md:inset-auto md:top-20 md:left-1/2 md:-translate-x-1/2 w-full md:w-[900px] h-[90vh] md:h-[700px] overflow-hidden z-50 window">
        ...
        <div className="window-content text-sm md:text-base p-4 h-[calc(100%-2rem)] overflow-y-auto">
          <div className="h-full flex items-center justify-center">{item && renderEmbed(item)}</div>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4">
      <blockquote
        ...
        data-instgrm-permalink="https://www.instagram.com/boweryshowroom/?utm_source=ig_embed&utm_campaign=loading"
      ...
      >
        <div style={{ padding: "16px" }}>
          <a
            href="https://www.instagram.com/boweryshowroom/?utm_source=ig_embed&utm_campaign=loading"
            style={{
              background: "#FFFFFF",
              lineHeight: 0,
              padding: "0 0",
