...
export default function AgeOfEmpires2() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-b from-amber-900 via-yellow-800 to-orange-900 p-4 sm:p-6">
      <div className="max-w-2xl text-center space-y-6">
        {/* Logo/Title */}
        <div className="space-y-2">
          <h1 className="text-4xl sm:text-6xl font-bold text-amber-200 drop-shadow-lg" style={{ fontFamily: "serif" }}>
            AGE OF
          </h1>
          <h2 className="text-3xl sm:text-5xl font-bold bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-600 bg-clip-text text-transparent">
            EMPIRES II
          </h2>
          <p className="text-lg sm:text-xl text-amber-300 font-semibold">The Age of Kings</p>
        </div>
        ...
        <button
          ...
          className="w-full max-w-md px-8 py-4 bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600 hover:from-amber-500 hover:via-yellow-500 hover:to-orange-500 text-white font-bold text-lg rounded-lg shadow-2xl transition-all transform hover:scale-105 active:scale-95"
        >
